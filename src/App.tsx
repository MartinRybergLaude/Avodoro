  ...
  return (
    <div className={styles.masterContainer}>
      ...
      <div className={styles.screensContainer}>
        <div
          className={
            styles.screenWrapper + " " + styles.start + " " + activated
          }
        >
          <ScreenStart />
        </div>
        <div
          className={
            styles.screenWrapper + " " + styles.timer + " " + activated
          }
        >
          {(activated === styles.activated || activated === styles.paused) && (
            <ScreenTimer
              focusLength={focusValue}
              shortBreakLength={shortBreakValue}
              longBreakLength={longBreakValue}
              run={activated === styles.activated ? true : false}
              pauseCallback={_handlePause}
            />
          )}
        </div>
      </div>
      <div className={styles.btnContainer}>
        <button
          ...
          className={styles.btn + " " + activated}
        >
